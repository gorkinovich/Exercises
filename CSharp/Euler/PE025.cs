...
namespace Euler {
    ...
    public class PE025 : IRunnable {
        ...
        public void Run () {
            ...
            var limit = BigInteger.Pow(10, SIZE - 1);
            var result = BigSequences.Fibonacci()
                                     .SkipWhile(x => x < limit)
                                     .First();

            Console.WriteLine($"The first term in the Fibonacci sequence to contain {SIZE} digits {result}.");
        }
    }
}
